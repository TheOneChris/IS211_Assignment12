...
cur.execute(
    "CREATE TABLE IF NOT EXISTS students( id INTEGER PRIMARY KEY AUTOINCREMENT NULL, first_name TEXT NULL, last_name TEXT NULL)")

cur.execute(
    "CREATE TABLE IF NOT EXISTS quizzes(id INTEGER PRIMARY KEY AUTOINCREMENT NULL, subject TEXT NULL, quiz_questions INTEGER NULL, date DATE NULL)")

cur.execute(
    "CREATE TABLE IF NOT EXISTS student_quiz_results(id INTEGER PRIMARY KEY AUTOINCREMENT NULL, student_first_name TEXT NULL,student_last_name TEXT NULL, score INTEGER NULL, FOREIGN KEY(student_first_name, student_last_name) REFERENCES students(first_name, last_name))")

cur.execute(
    "CREATE TABLE IF NOT EXISTS user (id INTEGER PRIMARY KEY AUTOINCREMENT NULL, username TEXT NULL, password TEXT NULL)")
...
def student_id(id):
    ...
    if request.method == 'GET':
        result = cur.execute(
            'SELECT id, student_first_name, student_last_name, score FROM student_quiz_results WHERE id=?',
            (id,)).fetchone()
